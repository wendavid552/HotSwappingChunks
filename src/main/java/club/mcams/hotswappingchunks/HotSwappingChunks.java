...
public class HotSwappingChunks implements ModInitializer
{
	public static final Logger LOGGER = LogManager.getLogger();

	public static final String MOD_ID = "hot_swapping_chunks";
	public static String MOD_VERSION = "unknown";
	public static String MOD_NAME = "HotSwappingChunks";
	@Override
